...
write(paste('STARTING!!!','Program'), file="~/Dropbox/FLAIRS-FINALFILES/testing123.csv", append=FALSE, sep="\t")
  # ===============================================================================
...
write(paste('Done container, starting training - ',ngram), file="~/Dropbox/FLAIRS-FINALFILES/testing123.csv", append=TRUE, sep="\t")
models <- train_models(container, algorithms=c("SVM", "MAXENT", "BOOSTING", "RF"));
write(paste('Done training, starting classify - ',ngram), file="~/Dropbox/FLAIRS-FINALFILES/testing123.csv", append=TRUE, sep="\t")
...
perf <- performance(pred, measure="tpr", x.measure="fpr");
 ...
 dev.off();
detach(data2);
write(paste('Done with POS BOW with Words BOWs - ',ngram), file="~/Dropbox/FLAIRS-FINALFILES/testing123.csv", append=TRUE, sep="\t")
